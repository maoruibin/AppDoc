...
不想打字的时候，输入框右侧还有一个麦克风按钮（输入框为空时显示，开始打字会自动让位）。点一下开口说，inBox 会自动帮你录音、转写成文字，再用 AI 把口语整理成一篇干净的笔记。

说话时可以暂停、继续，说完确认即可，最终得到的是「文字 + 原音」的笔记。详细用法见 [语音笔记](./voice-note.md)。

> Tip：语音笔记是 PRO 功能，免费用户有一定的体验额度。
